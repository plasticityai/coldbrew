...
echo -e "\n\nPATH=/usr/local/coldbrew/emsdk/node/8.9.1_64bit/bin:/usr/local/coldbrew/emsdk/upstream/bin:/usr/local/coldbrew/emsdk/clang/fastcomp/build_master_64/bin:$PATH" >> /usr/local/coldbrew/emsdk/emsdk_env.sh
